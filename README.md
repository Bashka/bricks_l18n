...
Пакет реализует механизм интернационализации приложения.
...
[исходные коды]: https://github.com/Bashka/bricks_l18n/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_l18n/issues
